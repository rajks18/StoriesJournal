            ...
            <div className="flex flex-wrap gap-2">
              {tags.map((tag, index) => (
                <a
                  key={index}
                  href="#"
                  className="px-4 py-13 bg-white border border-gray-300 rounded-full text-sm text-gray-700 hover:border-cyan-500 hover:text-cyan-500 transition-all duration-300"
                >
                  {tag}
                </a>
              ))}
